...
/* ----------------------------------------------------------------------
   5.  Seed Data
   ---------------------------------------------------------------------- */
INSERT INTO agencies (id,name,jurisdiction)
VALUES ('00000000-0000-4000-8000-000000000001','Demo Agency','Demo State')
...
INSERT INTO comments (id,docket_id,content,status,commenter_name,created_at)
VALUES ('00000000-0000-4000-8000-000000000003',
        '00000000-0000-4000-8000-000000000002',
        'Initial comment for search test','approved','Alice',now())
ON CONFLICT(id) DO NOTHING; 