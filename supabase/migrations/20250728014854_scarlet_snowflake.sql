/*
  # Add Comment Search Functions

  1. New Functions
     - `search_comments`: Search through published comments with filters
     - `get_comment_detail`: Get full comment details for detail page

  2. Security
     - Functions accessible to anon and authenticated users
     - Only returns published/approved comments

  3. Features
     - Full-text search on comment content and metadata
     - Advanced filtering by agency, state, tags, dates, etc.
